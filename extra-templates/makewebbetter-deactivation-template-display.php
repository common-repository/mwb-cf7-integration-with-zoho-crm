...
<?php if ( ! empty( $form_fields ) ) : ?>
	<div class="mwb-onboarding-section">
		...
		<div class="mwb-on-boarding-wrapper">
			...
			<p class="mwb-on-boarding-desc"><?php esc_html_e( 'May we have a little info about why you are deactivating?', 'mwb-cf7-integration-with-zoho' ); ?></p>
			<form action="#" method="post" class="mwb-on-boarding-form">
				...
				<div class="mwb-on-boarding-form-no_thanks">
					<a href="#" class="mwb-deactivation-no_thanks"><?php esc_html_e( 'Skip and Deactivate Now', 'mwb-cf7-integration-with-zoho' ); ?></a>
				</div>
				</div>
			</form>
		</div>
